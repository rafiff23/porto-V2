          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1}
                link="https://github.com/rafiff23"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/muhammad-rafif-838938232/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.4}
                link="https://www.researchgate.net/profile/Muhammad-Rafif-13?ev=hdr_xprf"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
            ...
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.8}
                link="muhammadrafif3225@gmail.com"
              />
            </MagneticEffect>
          </div>
