...
const faqs = [
  ...
  },
  {
    ...
    answer: [
      ...
      "• Optimizing Concrete Strength Prediction: A Random Forest Approach with Hyperparameter Tuning through Random Search for Enhanced Construction Quality, presented at ICICoS 2024.",
...
export default function Faq() {
  ...
  return (
    <section
      id="faq"
      className="relative w-full min-h-screen bg-zinc-100 text-black py-20"
    >
      <ContactRounded />

      <div className="px-6 max-w-4xl mx-auto font-sans">
